            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const TitleBar(title: "The Organisation"),
                  const SizedBox(height: 15),
                  Text(
                  ...
                  const SizedBox(height: 25),
                  const TitleBar(title: "Our Objective"),
                  const SizedBox(height: 15),
                  Text(
                  ...
                  const SizedBox(height: 20),
                  const TitleBar(title: "Our Vision"),
                  const SizedBox(height: 15),
                  Text(
                  ...
                  const SizedBox(height: 25),
                  const TitleBar(title: "Our Mission"),
                  const SizedBox(height: 15),
                  Text(
